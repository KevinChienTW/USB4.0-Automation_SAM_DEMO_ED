...
namespace USB4._0_Automation
{
    public partial class Main : Form
    {
        ...
        DeEmbeddB2 DeEmbeddB2_form = new DeEmbeddB2();
        calibration calibration_form = new calibration();
        Calibration_B2 CalibrationB2_form = new Calibration_B2();
        Run_setting run_setting_form = new Run_setting();
        HDMI_Run_setting HDMI_run_setting_form = new HDMI_Run_setting();
        
        Calibration_Version Calibration_Version_form = new Calibration_Version();
        //Form6 USB_TDR_calibration_form = new Form6();
        ...
        {
            Report_button.BackgroundImage = Properties.Resources.AutoReport_button_press;
        }
        private void Report_button_mouseMove(object sender, MouseEventArgs e)
        {
            Report_button.BackgroundImage = Properties.Resources.AutoReport_button_press;
        }
        ...
        {
            Report_button.BackgroundImage = Properties.Resources.AutoReport_button;
        }
        ...
        private void Run_test_button_Click(object sender, EventArgs e)
        {
            ...
            else if(Test_Mode == HDMI_Mode)
            {
                HDMI_run_setting_form = new HDMI_Run_setting();
                HDMI_run_setting_form.Show();
            }
        ...
        void TDR_ENV_SET()
        {
            ...
            //Trace1 & Trace5
            //mbSession_E5071C_tdr.RawIO.Write(":CALC1:DEV DIF2");                                            //DUT Topology --> Deferential 2-port
            //mbSession_E5071C_tdr.RawIO.Write(":CALC1:ATR:MARK:COUP OFF");                                   //Trace Control --> State of the time coupling
            //mbSession_E5071C_tdr.RawIO.Write(":CALC1:ATR:TIME:COUP OFF");                                   //Trace Control --> State of marker coupling
            //TDR_wait_done("*OPC?");
            //TDR_Query_response_value(":CALC1:DEV?", "DIF2\n");
            check_DIF2_ENV();
            ...
            //Set Trcae1 scale
            mbSession_E5071C_tdr.RawIO.Write(":DISP:TRAC1:X:SCAL:PDIV 200e-12");                           //set value of x-axis scale per division
            mbSession_E5071C_tdr.RawIO.Write(":DISP:TRAC1:X:SCAL:RLEV -200e-12");                          //set value of x-axis reference line
            mbSession_E5071C_tdr.RawIO.Write(":DISP:TRAC1:Y:SCAL:PDIV 5");                                 //sets value of Y-axis scale per division
            mbSession_E5071C_tdr.RawIO.Write(":DISP:TRAC1:Y:SCAL:RLEV 65");                                //sets value of y-axis reference line
            //Set Trcae scale
            mbSession_E5071C_tdr.RawIO.Write(":DISP:TRAC5:X:SCAL:PDIV 200e-12");                           //set value of x-axis scale per division
            mbSession_E5071C_tdr.RawIO.Write(":DISP:TRAC5:X:SCAL:RLEV -200e-12");                          //set value of x-axis reference line
            mbSession_E5071C_tdr.RawIO.Write(":DISP:TRAC5:Y:SCAL:PDIV 5");                                 //sets value of Y-axis scale per division
            mbSession_E5071C_tdr.RawIO.Write(":DISP:TRAC5:Y:SCAL:RLEV 65");                                //sets value of y-axis reference line
            TDR_wait_done("*OPC?");
        ...
        private void HDMI_tab_Click(object sender, EventArgs e)
        {
            Test_Mode = HDMI_Mode;
            groupBox1.BringToFront();
            USB_tab.BringToFront();
            HDMI_tab.BringToFront();
            HDMI_tab.BackgroundImage = Properties.Resources.HDMI_TAB;
            USB_tab.BackgroundImage = Properties.Resources.USB_TAB_Transparent;
            Report_button.Visible = false;
            DeEmbedd_button.Visible = false;

            DirectoryInfo di = new DirectoryInfo(System.Windows.Forms.Application.StartupPath + "\\" + "HDMI Project history");
            string files = "";
            string[] file_array;
            ...
            {
                if(files == "")
                    files = fi.Name.Replace(".ini","");
                else
                    files = files + "," + fi.Name.Replace(".ini", "");
            }
            file_array = files.Split(',');
            history_combobox.Items.AddRange(file_array);
            history_combobox.Text = DateTime.Now.ToString("yyyyMMdd");
            iniRecord = new IniManager(System.Windows.Forms.Application.StartupPath + "\\" + "HDMI Project history" + "\\" + DateTime.Now.ToString("yyyyMMdd") + ".ini");
        ...
        private void Project_listview_set()
        {
            ...
            //1、創建標題
            Project_list.Columns.Add("Project Name");
            Project_list.Columns.Add("Ver.");
        ...
        private void Result_listview_set()
        {
            //ListView顯示方式
            Result_list.View = View.Details;
            Result_list.BeginUpdate();
            #region 增加Item的標題，共有三個列
            //1、創建標題
            Result_list.Columns.Add("Test Item");
            Result_list.Columns.Add("Result");
            Result_list.AutoResizeColumns(ColumnHeaderAutoResizeStyle.HeaderSize);
            Result_list.GridLines = true;
            Result_list.GridLines = true;
            #endregion
            Result_list.EndUpdate();
        }

        private void Project_Result()
        {
            string All_project;
            string[] Test_items_data_V2_1 = { "HF7-2", "HF7-3", "HF7-4_Near", "HF7-4_Far", "HF7-5", "HF7-7" };
            string[] Test_items_HEAC_and_HF7_6_V2_1 = { "HF7-6", "HF7-12", "HF7-13", "HF7-14", "HF7-15" };
            string[] Test_items_data_V1_4 = { "HF5-6_CKD0", "HF5-6_CKD1", "HF5-6_CKD2", "HF5-6_D0D1", "HF5-6_D0D2", "HF5-6_D1D2", "HF5-7_D0D0", "HF5-7_D1D1", "HF5-7_D2D2", "HF5-7_CKCK", "HF6-2"};
            int list_item_i = 0;
            bool Test_item_Result;
            
            Project_list.Clear();
            Project_listview_set();
            Project_list.BeginUpdate();

            All_project = iniRecord.ReadIniFile("All_Project", "Project", "");
            if(All_project != "")
            {
                foreach (string Project_name in All_project.Split(','))
                {
                    Test_item_Result = true;
                    list_item_i = list_item_i + 1;
                    Project_list.Items.Add("project" + list_item_i.ToString(), Project_name, 0);
                    Project_list.AutoResizeColumn(0, ColumnHeaderAutoResizeStyle.HeaderSize);
                    if (iniRecord.ReadIniFile(Project_name, "Version", "") == "2.1")
                    {
                        Project_list.Items["project" + list_item_i.ToString()].SubItems.Add("2.1");
                        Project_list.AutoResizeColumn(1, ColumnHeaderAutoResizeStyle.HeaderSize);
                        foreach (string Test_item in Test_items_data_V2_1)
                        {
                            for (int i = 0; i < 4; i++)
                            {
                                string item = Test_item + "_D" + i.ToString();
                                if (iniRecord.ReadIniFile(Project_name, item, "") != "Pass")
                                {
                                    Test_item_Result = false;
                                }
                            }
                        }
                        foreach (string Test_item in Test_items_HEAC_and_HF7_6_V2_1)
                        {
                        ...
                        if (Test_item_Result)
                        {
                            Project_list.Items["project" + list_item_i.ToString()].SubItems.Add("Pass");
                            Project_list.Items["project" + list_item_i.ToString()].SubItems[0].ForeColor = Color.Green;
                        }
                        else
                        {
                            Project_list.Items["project" + list_item_i.ToString()].SubItems.Add("Fail");
                            Project_list.Items["project" + list_item_i.ToString()].SubItems[0].ForeColor = Color.Red;
                        }
                        Project_list.AutoResizeColumn(2, ColumnHeaderAutoResizeStyle.HeaderSize);
                    }
                    else if(iniRecord.ReadIniFile(Project_name, "Version", "") == "1.4")
                    {
                        Project_list.Items["project" + list_item_i.ToString()].SubItems.Add("1.4");
                        Project_list.AutoResizeColumn(1, ColumnHeaderAutoResizeStyle.HeaderSize);
                        foreach (string Test_item in Test_items_data_V1_4)
                        {
                            for (int i = 0; i < 4; i++)
                            {
                                if (iniRecord.ReadIniFile(Project_name, Test_item, "") != "Pass")
                                {
                                    Test_item_Result = false;
                                }
                            }
                    ...
                    {
                        Project_list.Items["project" + list_item_i.ToString()].SubItems.Add("1.4&2.1");
                        Project_list.AutoResizeColumn(1, ColumnHeaderAutoResizeStyle.HeaderSize);
                        foreach (string Test_item in Test_items_data_V1_4)
                        {
                            for (int i = 0; i < 4; i++)
        ...
        private void Project_list_DoubleClick(object sender, EventArgs e)
        {
            string Project_name = Project_list.SelectedItems[0].Text;
            string[] Test_items_data_V1_4 = { "HF5-6_CKD0", "HF5-6_CKD1", "HF5-6_CKD2", "HF5-6_D0D1", "HF5-6_D0D2", "HF5-6_D1D2", "HF5-7_D0D0", "HF5-7_D1D1", "HF5-7_D2D2", "HF5-7_CKCK", "HF6-2"};
            string[] Test_items_data_V2_1 = { "HF7-2", "HF7-3", "HF7-4_Near", "HF7-4_Far", "HF7-5", "HF7-7" };
            string[] Test_items_HEAC_and_HF7_6_V2_1 = { "HF7-6", "HF7-12", "HF7-13", "HF7-14", "HF7-15" };
            int item_i = 0;
            ...
            if (iniRecord.ReadIniFile(Project_name, "Version", "") == "2.1")
            {
                foreach (string Test_item in Test_items_data_V2_1)
                {
                    for (int i = 0; i < 4; i++)
                    {
                        item_i = item_i + 1;
                        string item = Test_item + "_D" + i.ToString();
                        Result_list.Items.Add("item" + item_i.ToString(), item, 0);
                        Result_list.AutoResizeColumn(0, ColumnHeaderAutoResizeStyle.HeaderSize);
                        if (iniRecord.ReadIniFile(Project_name, item, "") == "Pass")
                        {
                            Result_list.Items["item" + item_i.ToString()].SubItems.Add("Pass");
                            Result_list.Items["item" + item_i.ToString()].SubItems[0].ForeColor = Color.Green;
                        }
                        else if (iniRecord.ReadIniFile(Project_name, item, "") == "")
                        {
                            Result_list.Items["item" + item_i.ToString()].SubItems.Add("N/A");
                            Result_list.Items["item" + item_i.ToString()].SubItems[0].ForeColor = Color.Black;
                        }
                        else
                        {
                            Result_list.Items["item" + item_i.ToString()].SubItems.Add("Fail");
                            Result_list.Items["item" + item_i.ToString()].SubItems[0].ForeColor = Color.Red;
                        }
                    }
                }
                foreach (string Test_item in Test_items_HEAC_and_HF7_6_V2_1)
        ...
        private void USB_tab_Click(object sender, EventArgs e)
        {
            ...
            HDMI_tab.BackgroundImage = Properties.Resources.HDMI_TAB_Transparent;
        ...
        private void Fixture_board_button_Click(object sender, EventArgs e)
        {
            ...
            {
                diagram_HDMI lForm = new diagram_HDMI();
                lForm.Owner = this;
                lForm.ShowDialog();
            }
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                HDMI_Calibration.Visible = false;
            }
        }

        private void button1_Click(object sender, EventArgs e)
        {
            USB_TDR lForm = new USB_TDR();
            lForm.Owner = this;
            lForm.ShowDialog();
        }
        ...
        private void HDMI_Calibration_Click(object sender, EventArgs e)
        {
            
            Calibration_Version_form = new Calibration_Version();
            Calibration_Version_form.Show();
            //calibration_form.Owner = this;
            
        }

        private void HDMI_Calibration_MouseDown(object sender, MouseEventArgs e)
        {
            HDMI_Calibration.BackgroundImage = Properties.Resources.button_blue_s_1;
        }

        private void HDMI_Calibration_MouseMove(object sender, MouseEventArgs e)
        {
            HDMI_Calibration.BackgroundImage = Properties.Resources.button_blue_s_1;
        }

        private void HDMI_Calibration_MouseLeave(object sender, EventArgs e)
        {
            HDMI_Calibration.BackgroundImage = Properties.Resources.button_blue_s;
        }

        private void HDMI_Calibration_MouseUp(object sender, MouseEventArgs e)
        {
            HDMI_Calibration.BackgroundImage = Properties.Resources.button_blue_s;
        }
        ...
        {
            string selection_date = history_combobox.Text;
            iniRecord = new IniManager(System.Windows.Forms.Application.StartupPath + "\\" + "HDMI Project history" + "\\" + selection_date + ".ini");
